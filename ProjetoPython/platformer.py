...
# game loop
    ...
    # verificar se a porta de fim de nivel está desbloqueada
   # for entity in globals.world.entities:
    #    if isinstance(entity, engine.Button):
    #        if entity.check_press(level.players):
    #            for e in globals.world.entities:
    #                if isinstance(e, engine.Door):
     #                   e.unlock()  
